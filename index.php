...
-->
     ...
     <meta name="description" content="Fabricant de chocolat officiel pour les étudiants du groupe 2285 à la HEPL">
                    ...
                    <div class="owl-carousel owl-theme">
                         <div class="item item-first">
                         	<figure class="item_bg">
                         		<img src="./content/slide1.jpg" alt="morceau de chocolat cassés" class="item_img">
                         	</figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             <h3><?php echo('Coucou je vends du chocolat&nbsp!');?></h3>
                                             <h3><?='Coucou je vends du chocolat&nbsp;!'?></h3>
                         ...
                         <div class="item item-second">
                         	<figure class="item_bg">
                         		<img src="./content/slide2.jpg" alt="barres de chocolat" class="item_img">
                         	</figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                         ...
                         <div class="item item-third">
                         	<figure class="item_bg">
                         		<img src="./content/slide1.jpg" alt="assietes de chocolat" class="item_img">
                         	</figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
